...
function renderFootnote() {
  document.getElementById('footnote').innerHTML = `
    ...
    재산세·종합부동산세 계산은 <b>1세대1주택자</b> 특례(공정시장가액비율 45%, 종부세 11억 공제)를 기준으로 하며, 다주택자에는 적용되지 않습니다.
...
function buildReport() {
  ...
  let html = `
    ...
    <div class="rp-assumptions">
      ...
      <div>재산세·종합부동산세 계산은 1세대1주택자 특례(공정시장가액비율 45%, 종부세 11억 공제)를 기준으로 하며, 다주택자에는 적용되지 않습니다.</div>
